...
import com.demonwav.ectotokens.config.main.nav.EctoInfoButtonConfig;
...
public class GuiConfig implements Config {
    ...
    private EctoInfoButtonConfig infoButton;
    private int height;
    ...
    public boolean validate(Logger logger) {
        boolean result = Configs.validate(logger, leftNavButton, rightNavButton, backButton, closeButton, infoButton);
